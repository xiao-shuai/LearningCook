...
class Detail extends Component{
   ...
   componentWillMount(){
    ...
    this.setState({
      zannum:info.item.appreciate,
      shounum:info.item.score_grade
    })
   ...
   render(){
    ...
    console.log('info---now???!',info,this.state.zannum,this.state.shounum)
       ...
       <Image style={{width:'100%',height:200,marginTop:5,borderRadius:10}} source={{uri:info.item.cover}}/>
       <View style={{
       alignItems:'center',
      paddingTop:10,
      paddingBottom:10,
      ...
      </View>
      {
        ...
        return(
          <View style={{marginTop:20,}} key={index}>
            ...
            <Image source={{uri:item.image}} style={{width:'100%',height:200,marginTop:Metrics.CH*.01,borderRadius:8}} />
